    ...
    public class MonitoringMiddlewareService
    {
        ...
        public async Task InvokeAsync(HttpContext context)
        {
            ...
            finally
            {
                ...
                {
                    var rabbitProducer = scope.ServiceProvider.GetRequiredService<IRabbitMqLogOperationResultProducer>();
                    await rabbitProducer.SendOperationLogResultMessage(result);
                }
            }
        }
    }
